 ...
 */
@RestController
@RequestMapping(value = RequestMappings.SELLERS_V1, produces = MediaType.APPLICATION_JSON_VALUE)
public class SellerController extends AbstractUserController {
	...
	public ResponseEntity<ServiceResponseVO> insertUserRating(@PathVariable(value = "userid", required=true) final String userid,
		...
		return insertUserRating(userid, projectId, UserRating.Type.BUYER, rating);
